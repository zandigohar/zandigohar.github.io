...
<head>
  ...
  <style>
    ...
    a{color:var(--accent);} a:hover{color:#fff;text-decoration:none;}
    ...
    /* ===== Hero ===== */
    #hero{
      height:100vh;background:#000 url('/assets/img/hero.jpg') center/cover fixed;
...
<section id="hero">
  ...
  <a class="btn btn-default" href="/assets/CV_mehrdad_v10.pdf" style="margin-top:20px"><code>&lt;resume&gt;</code></a>
</section>
...
<section id="about">
  <div class="container">
    ...
    <p><strong>PhD candidate in Bioinformatics (UIC, 2020 – 2025)</strong><br>
       ...
       I build <em>interpretable</em> VAEs, transformers, and retrieval-augmented pipelines to map TF networks and cell-cell communication.</p>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-4"><div class="card">
        <strong>Graduate Research Assistant – UIC</strong>
        <div class="time">2023 – 2025</div>
        Created <em>scRegulate</em>, a TF-aware VAE improving AUROC&nbsp;10-50 % and robust under 30 % dropout.
      </div></div>

      <div class="col-sm-4"><div class="card">
        <strong>Research Assistant – UIC</strong>
        <div class="time">2021 – 2023</div>
        Benchmarked latent-inference for sparse scATAC-seq; first-author @ IEEE BIBM 2022.
      </div></div>

      <div class="col-sm-4"><div class="card">
        <strong>Lab Computing Lead – UIC</strong>
        <div class="time">2022 – present</div>
        Ran three GPU servers, secured an NVIDIA grant, mentored 10 + scientists on CUDA workflows.
      </div></div>
    </div>
  </div>
</section>
...
<section id="projects">
  <div class="container">
    ...
    <ul>
      ...
      <li><strong>Single-cell Atlas of Uterine Fibroids</strong> – 16 cell types; <em>Hum. Reprod.</em> 2022.</li>
    </ul>
  </div>
</section>
...
<section id="publications">
  <div class="container">
    ...
    <ul>
      <li><em>scRegulate…</em> <strong>bioRxiv</strong> 2025.</li>
      <li><em>Macrophage Heterogeneity in Skin Wound Healing.</em> <strong>J Immunol</strong> 2024.</li>
      <li><em>Info Retrieval in Single-Cell Chromatin.</em> <strong>IEEE BIBM</strong> 2022.</li>
    </ul>
  </div>
</section>
